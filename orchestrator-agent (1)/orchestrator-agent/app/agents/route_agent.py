...
def run_route_agent(G, engine, scenario_id: int, origin_stop_id: int, destination_stop_id: int) -> dict:
    ...
    try:
        ...
        reasoning_text = response.choices[0].message.content or _fallback_reasoning(recommended)
    except Exception:
